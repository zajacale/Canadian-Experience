...
std::shared_ptr<CActor> CHaroldFactory::Create()
{
	...
	headt->AddToPoints(Point(32, 63)); //left eyebrow start
	headt->AddToPoints(Point(46, 59)); //left eyebrow finish
	headt->AddToPoints(Point(63, 59)); //right eyebrow start
	headt->AddToPoints(Point(77, 62)); //right eyebrow finish
	headt->AddToPoints(Point(42, 79)); //left eye center
	headt->AddToPoints(Point(69, 79)); //right eye center
