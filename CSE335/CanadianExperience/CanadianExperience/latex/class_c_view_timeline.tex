...
\subsubsection[{On\+Draw(\+C\+D\+C $\ast$p\+D\+C)}]{\setlength{\rightskip}{0pt plus 5cm}void C\+View\+Timeline\+::\+On\+Draw (
\begin{DoxyParamCaption}
...
\subsubsection[{On\+Erase\+Bkgnd(\+C\+D\+C $\ast$p\+D\+C)}]{\setlength{\rightskip}{0pt plus 5cm}B\+O\+O\+L C\+View\+Timeline\+::\+On\+Erase\+Bkgnd (
\begin{DoxyParamCaption}
\item[{C\+D\+C $\ast$}]{p\+D\+C}
\end{DoxyParamCaption}
...
\subsubsection[{Set\+Main\+Frame(\+C\+Main\+Frame $\ast$main\+Frame)}]{\setlength{\rightskip}{0pt plus 5cm}void C\+View\+Timeline\+::\+Set\+Main\+Frame (
\begin{DoxyParamCaption}
...
\subsubsection[{Update\+Observer() override}]{\setlength{\rightskip}{0pt plus 5cm}void C\+View\+Timeline\+::\+Update\+Observer (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
